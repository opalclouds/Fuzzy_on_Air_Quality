...
Tracks the calculated **Fuzzy Health Hazard Score $[0, 100]$** alongside raw $\text{PM}_{2.5}$ concentrations across 150 days of sensor readings in Ahmedabad.

![Fuzzy Hazard Score vs PM2.5](assets/membership_functions.png)

### 3. Comparison: Official Kaggle AQI vs. Fuzzy Hazard Model
Benchmarking our scaled Fuzzy Hazard Score against the official step-function Kaggle AQI metric to demonstrate smoother continuous risk transitions.
